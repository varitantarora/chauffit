...
import { TextInput, TouchableOpacity, Alert, View, SafeAreaView, Text, Image, Platform, Linking } from 'react-native';
  ...
  const handlePhoneLogin = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        } else if (response.error?.includes('No account found')) {
          router.push({
