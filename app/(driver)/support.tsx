...
export default function SupportScreen() {
  ...
  const handleUserGuides = () => {
    router.push('/(driver)/user-guides');
  };
  ...
  const handleEmailSupport = () => {
    Linking.openURL('mailto:driver-support@chauffit.com');
  };
  ...
  const handleSubmitRequest = () => {
    router.push('/(driver)/submit-request');
  };

  const handleCheckStatus = () => {
    router.push('/(driver)/request-status');
  };
