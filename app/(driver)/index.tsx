...
import { ScrollView, TouchableOpacity, View, Switch, RefreshControl } from 'react-native';
          ...
          <View className="px-6">
            ...
            <ThemedCard className="mb-3">
              <View className="flex-row items-center">
                ...
                <View className="items-end">
                  <ThemedText className="font-bold text-primary">₹2,850</ThemedText>
            ...
            <ThemedCard className="mb-3">
              <View className="flex-row items-center">
                ...
                <View className="ml-3 flex-1">
                  <ThemedText className="font-semibold">Business Meeting</ThemedText>
                  <ThemedText variant="caption">Completed • 4 hours ago</ThemedText>
                  <ThemedText variant="caption">Hotel Oberoi → Unitech Cyber Park</ThemedText>
                </View>
                <View className="items-end">
                  <ThemedText className="font-bold text-primary">₹1,500</ThemedText>
                  <View className="flex-row items-center mt-1">
                    {[1, 2, 3, 4].map((star) => (
                      <Ionicons key={star} name="star" size={12} color="#fbbf24" />
                    ))}
