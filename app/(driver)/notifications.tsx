...
interface NotificationSetting {
  ...
  icon: string;
  enabled: boolean;
  category: 'rides' | 'earnings' | 'marketing' | 'security';
}
...
export default function NotificationsScreen() {
  ...
  const [notifications, setNotifications] = useState<NotificationSetting[]>([
    // Ride Notifications
    {
      ...
      description: 'Get notified when new ride requests are available',
      icon: 'car',
      enabled: true,
      category: 'rides'
    },
    {
      id: 'ride_accepted',
      title: 'Ride Accepted',
      description: 'Confirmation when you accept a ride request',
    ...
    },
    {
      ...
      description: 'Messages from customers during rides',
      icon: 'chatbox',
      enabled: true,
      category: 'rides'
    },
    {
      id: 'trip_updates',
      title: 'Trip Updates',
      description: 'Updates about ongoing trips and navigation',
      icon: 'location',
      enabled: true,
      category: 'rides'
    },
    {
      ...
      description: 'Notifications when trips are completed',
      icon: 'flag',
      enabled: true,
      category: 'rides'
    },
    ...
    },
    {
      ...
      description: 'Weekly summary of your earnings and rides',
      icon: 'stats-chart',
      enabled: true,
      category: 'earnings'
    },
    {
      ...
      description: 'Alerts about available bonuses and incentives',
      icon: 'gift',
      enabled: true,
      category: 'earnings'
    },
    ...
    // Marketing Notifications
    {
      ...
      description: 'Special promotions and earning opportunities',
      icon: 'pricetag',
      enabled: false,
      category: 'marketing'
    },
    {
      id: 'new_features',
      title: 'New Features',
      description: 'Updates about new driver app features',
      icon: 'sparkles',
      enabled: true,
      category: 'marketing'
    },
    {
      ...
      description: 'New training materials and driver resources',
      icon: 'school',
      enabled: true,
      category: 'marketing'
    },
    ...
    },
    {
      ...
      description: 'Reminders for document renewals and updates',
      icon: 'document-text',
      enabled: true,
      category: 'security'
    },
    {
      ...
      description: 'Notifications about account or profile changes',
      icon: 'person',
      enabled: true,
      category: 'security'
    }
  ...
  const categories = [
    { id: 'rides', title: 'Ride Notifications', description: 'Stay updated about ride requests and trips' },
    { id: 'earnings', title: 'Earnings & Payments', description: 'Track your earnings and payments' },
    { id: 'marketing', title: 'Promotions & Updates', description: 'Earning opportunities and new features' },
    { id: 'security', title: 'Security & Account', description: 'Important account and document notifications' }
  ];
