              ...
              <ThemedCard className="p-4 mb-6">
                ...
                <View className="space-y-3">
                  ...
                  <View className="flex-row items-center justify-between">
                    ...
                    <ThemedText
                      className={`font-semibold capitalize ${bikerProfile?.license_number ? 'text-success' : 'text-secondary'
                        }`}
                    >
                  ...
                  {documents && documents.length > 0 ? (
                    documents.map((doc: any) => (
                      <View key={doc.id} className="flex-row items-center justify-between">
                        ...
                        <ThemedText
                          className={`font-semibold capitalize ${doc.verification_status === 'approved' ? 'text-success' :
                ...
                <View className="space-y-3">
                  ...
                  >
                    <View className="flex-row items-center">
                      ...
                      <ThemedText className="ml-3 font-semibold">{t('helpSupport')}</ThemedText>
                    </View>
                    <Ionicons name="chevron-forward" size={16} color={isDarkMode ? '#9ca3af' : '#6b7280'} />
                  </TouchableOpacity>
                </View>
                ...
                <View className="space-y-3">
                  <View className="flex-row items-center justify-between p-3 bg-surface dark:bg-darkSurface rounded-lg">
                    <View className="flex-row items-center">
                      ...
                      <ThemedText className="ml-3 font-semibold">{t('darkMode')}</ThemedText>
                    </View>
                    <Switch
                      value={isDarkMode}
                  ...
                  >
                    <View className="flex-row items-center">
                      ...
                      <ThemedText className="ml-3 font-semibold">{t('language')}</ThemedText>
                    </View>
                    <View className="flex-row items-center">
                  ...
                  >
                    <View className="flex-row items-center">
                      ...
                      <ThemedText className="ml-3 font-semibold">{t('notifications')}</ThemedText>
                    </View>
                    <Ionicons name="chevron-forward" size={16} color={isDarkMode ? '#9ca3af' : '#6b7280'} />
                  </TouchableOpacity>
